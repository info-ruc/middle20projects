...
<form class="layui-form" action="/admin/save?id={{.id}}"  method="post" style="margin:20px">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="url" value="{{.post.Url}}" placeholder="请输入下载链接" autocomplete="off" class="layui-input">
        </div>
    </div>
